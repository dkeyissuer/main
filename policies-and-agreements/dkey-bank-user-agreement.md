...
您同意赔偿DKEY银行经营者、其隶属机构、承包商及许可方，并使它们免受因以下原因引致或与以下原因相关的任何索赔、诉讼、程序、调查、要求、诉讼、成本、费用和损害（包括律师费、罚金或任何监管机关收取的罚款）：（i）您使用DKEY银行服务或与DKEY银行服务相关的行为；（ii）您违反DKEY银行用户协议或我们执行DKEY银行用户协议；或（iii）您在使用DKEY银行服务期间违反任何适用法律、法规或任何第三方的权利。如果根据DKEY银行用户协议，您有义务赔偿DKEY银行经营者、其隶属机构、承包商及许可人，DKEY银行将有权自行控制任何诉讼或程序，并确定DKEY银行是否希望和解，如果愿意，基于什么条款和解。
