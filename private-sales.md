...
{% file src=".gitbook/assets/dkey-yin-hang-ying-yong-zhu-ce-jiao-cheng-ui-ux-2.0 \(1\).pdf" caption="DKEY银行应用注册教程" %}
...
{% file src=".gitbook/assets/dkey-yin-hang-ying-yong-zhu-ce-jiao-cheng-ui-ux-2.0.pdf" caption="DKEY银行应用注册教程" %}
